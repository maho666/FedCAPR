...
class DukeMTMC(BaseImageDataset):
    ...
    def __init__(self, root, verbose=True, **kwargs):
        ...
        self.train, self.train_pid, self.train_camid= self._process_dir(self.train_dir, relabel=True)
        self.query, self.query_pid, self.query_camid = self._process_dir(self.query_dir, relabel=False)
        self.gallery, self.gallery_pid, self.gallery_camid = self._process_dir(self.gallery_dir, relabel=False)
